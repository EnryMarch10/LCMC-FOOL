 ...
 * Performs the code generation of assembly instructions (called "stack machine instructions"),
 * acting as the Code Generator (4-th and last component of the Compiler).
 */
