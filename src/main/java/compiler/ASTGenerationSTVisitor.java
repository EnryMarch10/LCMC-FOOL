 ...
 * Performs the last step of the Parser (2-nd component of the Compiler).
 * Starts from a stream of tokens generated by the Lexer (1-st component of the Compiler).
 */
